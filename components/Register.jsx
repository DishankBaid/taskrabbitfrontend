      ...
      <div className="px-8 py-6 mt-4 text-left bg-white shadow-lg w-1/3">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
          ...
          <div className="flex items-center justify-between mt-4">
            <button className="px-12 text-black py-2 leading-5 text-white transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-blue-700">
              Register
            </button>
          </div>
          {errors.root && (
